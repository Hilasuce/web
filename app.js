...
function agregarItemAlCarrito(titulo, precio, imagenSrc){
    ...
    item.classList.add('item');  // Cambio aquí: uso correcto de classList.add
...
function actualizarTotalCarrito(){
    ...
    for(var i = 0; i < carritoItems.length; i++){
        ...
        // Eliminamos el símbolo de moneda y el punto de miles, luego convertimos a número.
        var precio = parseFloat(precioElemento.innerText.replace('Q', '').replace(/,/g, '')); 
    ...
    document.getElementsByClassName('carrito-precio-total')[0].innerText = 'Q' + total.toFixed(2);  // Usamos toFixed(2) para asegurar dos decimales.
}
